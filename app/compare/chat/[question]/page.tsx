    ...
    >
      <div className="grid min-h-full w-[180vw] snap-start grid-cols-2 md:w-full">
        <div 
          ...
          className="flex min-h-full flex-col overflow-x-hidden bg-gray-50 px-4 md:w-full lg:px-16 dark:bg-black transition-opacity duration-150 ease-out"
        >
        ...
        <div 
          ...
          className="flex h-full min-h-full snap-end flex-col overflow-x-hidden border-l bg-gradient-to-r from-[#5BCEFA]/20 via-[#FFFFFF]/20 to-[#F5A9B8]/20 px-4 md:w-full lg:px-16 dark:bg-gradient-to-r dark:from-[#5BCEFA]/20 dark:via-[#2D2D2D]/20 dark:to-[#F5A9B8]/20 transition-opacity duration-150 ease-out"
        >
          <h1 className="mt-4 mb-2 border-b pb-4 text-xl font-bold sm:text-2xl md:mt-8">
            <a
