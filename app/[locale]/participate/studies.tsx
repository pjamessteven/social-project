...
export default function Studies() {
  return (
    <Accordion type="single" collapsible className="not-prose w-full space-y-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <p className="text-muted-foreground text-sm text-gray-700 dark:text-gray-300">
                    Individuals who once identified as transgender, non-binary
                    or other gender identities outside their birth sex, who
                    socially detransitioned and no longer identify outside their
                    birth sex identity. No medical/surgical treatments
                    undertaken.
                  </p>
                </div>
                <div className="rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
            ...
            <section>
              ...
              <div className="rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                <ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                  <li>
                    - Examine pathways of individuals who previously identified
                    as transgender
                  </li>
                  <li>
                    - Explore biopsychosocial factors in identity development
                  </li>
                  <li>- Understand current experiences and functioning</li>
                  <li>- Advance science-based healthcare for individuals</li>
                </ul>
              </div>
            </section>
      ...
      <AccordionItem
        value="study-2"
        className="bg-secondary s rounded-lg border border-gray-200 dark:border-gray-700 dark:bg-gray-900"
      >
        <AccordionTrigger className="p-6 hover:no-underline">
          <div className="text-left">
        ...
        <AccordionContent className="p-6 pt-0">
          <div className="space-y-8 pt-4">
            <section>
              ...
              <div className="rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                <ul className="space-y-3 text-sm text-gray-700 sm:columns-2 dark:text-gray-300">
                  <li className="flex items-start">
                    <span className="mt-1 mr-3 h-2 w-2 flex-shrink-0 rounded-full bg-current text-blue-500" />
                    18 years or older
                  </li>
                  <li className="flex items-start">
                    <span className="mt-1 mr-3 h-2 w-2 flex-shrink-0 rounded-full bg-current text-blue-500" />
