...
const studiesData = [
  {
    headline:
      "50-Fold Increase in Gender Dysphoria/Incongruence in English Youth (2011-2021)",
    title:
  ...
  {
    headline:
      "70% of Gender-Dysphoric Children Desist by Puberty When Mental Health Issues Are Treated",
    title:
  ...
  {
    headline:
      "Major Correction: Landmark Study's Claims of Surgery Benefits Were Wrong—No Improvement in Mental Health",
    title:
  ...
  {
    headline:
      "Permanent Loss: Detransitioned Woman Grieves Inability to Breastfeed After Mastectomy",
    title:
  ...
  {
    headline:
      "Social Contagion Factor: 256 Parent Reports Link Peer Groups to Sudden Gender Dysphoria Onset",
  ...
  {
    headline:
      "'The Man I'm Trying to Be Is Not Me': Transition Failed to Resolve Patient's Underlying Trauma",
  ...
  {
    headline:
      "Slow Down, Open Up: Exploratory Therapy Model Proposed for Gender-Dysphoric Youth",
    title:
  ...
  {
    headline:
      "Transgender Identity Can Be 'Trans-itory': Psychoanalyst Warns Against Premature Embrace",
    title:
  ...
  {
    headline:
      "Very Low Certainty Evidence: Major Review Questions Mental Health Benefits of Cross-Sex Hormones",
    title:
  ...
  {
    headline:
      "Bone Density Concerns: Transgender Youth Already Have Lower BMD Before Any Treatment Begins",
    title:
...
export default async function StudiesPage({
  ...
  const { locale } = await params;
  const t = await getTranslations({ locale, namespace: "studiesPage" });
  //  const studies = await fetchStudies(locale);
