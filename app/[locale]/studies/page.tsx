...
export default async function StudiesPage() {
  return (
    <div className="prose dark:prose-invert pb-16 lg:pt-8">
      ...
      <p>
        Academic studies, peer-reviewed research and journal articles on the
        subjects of gender identity, transition and de-transition. If you would
        like to submit a study, please send it through to me using the contact
        form.
      </p>
      <ParticipateCard />
