        ...
        <form onSubmit={handleSubmit} className="flex w-3xl items-center gap-2">
          <div className="relative flex-1 grow">
            ...
            {showSuggestions && suggestions.length > 0 && (
              <div className="absolute bottom-0 left-0 right-0 pb-32 z-0 overflow-y-auto rounded-bl-[32px] rounded-br-[32px] rounded-lg border bg-white shadow-xl dark:border-slate-700 dark:bg-slate-800 animate-in fade-in-0 duration-200">
