        ...
        >
          ...
          >
            <div className="flex w-full flex-col">
              <div className="flex w-full flex-row items-center justify-between p-3 dark:bg-black/30">
                <div className="no-wrap flex flex-row items-baseline pr-2">
                  <div className="text-primary-background text-sm font-normal">
                ...
                <div>
                  ...
                  {!isLoading && !isError && !disableExpand && (
                    <div className="flex items-center text-sm">
                      <ChevronDown className="mr-1 h-4 w-4 shrink-0 transition-transform duration-200 group-data-[state=open]:rotate-180" />
                    </div>
                  )}
                  {isError && (
