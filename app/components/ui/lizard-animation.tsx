  ...
  return (
    <svg
      ...
      style={{
        stroke: "#edf2f6",
        animation:
          "lizard-dashoffset 1s ease both, lizard-fill-opacity 1s ease both, lizard-stroke-opacity 1s ease both",
        strokeDasharray: "500%",
