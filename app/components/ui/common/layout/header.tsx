...
export default function Header({
  ...
  return (
    <div className="relative top-0 right-0 left-0 z-50 flex items-center bg-transparent p-2 px-4 shadow-none transition-all">
      ...
      <div className="z-50 flex flex-1 items-center gap-2">
      ...
      <div className="hidden flex-shrink-0 items-center md:flex">
        <SlidingNavGroup
          pillClassName="shadow-[0px_0px_0px_1px_rgba(14,63,126,0.06),0px_1px_1px_-0.5px_rgba(42,51,70,0.03),0px_2px_2px_-1px_rgba(42,51,70,0.04),0px_3px_3px_-1.5px_rgba(42,51,70,0.04),0px_5px_5px_-2.5px_rgba(42,51,70,0.03),0px_10px_10px_-5px_rgba(42,51,70,0.03),0px_24px_24px_-8px_rgba(42,51,70,0.03)] backdrop-blur dark:bg-secondary bg-white "
          className=""
          tabClassName=""
          tabs={allTabs}
          moreDropdown={
      ...
      <div className="flex flex-1 items-center justify-end gap-2">
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          {isOpen && (
            <div className="absolute top-0 left-0 -z-10 h-64 w-full bg-white dark:bg-black" />
          )}
