...
export default function ParticipateCard() {
  ...
  return (
    <Link prefetch={false} href="/participate" className="no-underline">
      <Card className="group bg-lizard-200/30 border-lizard-400 dark:border-lizard-700/50 dark:bg-lizard-900/70 relative cursor-pointer overflow-hidden rounded-xl border transition-all duration-500 hover:brightness-110">
