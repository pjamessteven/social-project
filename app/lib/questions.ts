export const questionCategories = [
  {
    ...
    questions: [
      ...
      "How can gender-nonconformity liberate us from gender?",
      ...
      "How does asking a gender-nonconfroming person what their pronouns are, reinforce sexist stereotypes?",
  ...
  },
  {
    ...
    questions: [
      ...
      "Should everyone else have to pay for transgender people's cosmetic surgeries?",
  ...
  },
  {
    ...
    questions: [
      ...
      "What is an identity trap?",
      "Does transition ever end?",
      "Can trans identity itself cause dysphoria?",
