export const questionCategories = [
  {
    ...
    questions: [
      ...
      "Why do some people describe the feeling of being ‘born in the wrong body’?",
      "What is gender-affirming care and what are its goals?",
      "What is gender-exploratory therapy and how does it differ from gender-affirming care?",
      "Why is gender-affirming care easier to access than exploratory therapy in many regions?",
      ...
      "How can friends or family support someone who thinks they are in an identity trap?",
      "Where can someone look for a therapist who offers open-ended, non-directive gender exploration?",
      ...
      "How do non-binary labels interact with traditional gender stereotypes?",
      "What is cancel culture and what measurable effects does it have on public health discourse?",
      "Does transition have a defined end-point or is it an ongoing process?",
      "Why might some adolescent girls experience distress about breast development?",
      "How do online echo-chambers influence identity formation in adolescents?",
      "Why do detransitioners often report feeling silenced in both trans and mainstream spaces?",
      "What demographic patterns are visible in referrals to gender clinics?",
      "How do contemporary queer identities differ from earlier LGB organising?",
      "What does current research say about overlap between autism spectrum traits and gender dysphoria?",
      ...
      "How has trans prevalence changed over the past 30 years and what might explain this?",
    ],
  },
  {
    title: "General Terms",
    ...
    questions: [
      ...
      "What is a woman?",
      "What is gender?",
      "What are pronouns and why are they significant to trans people?",
      "What rights are covered by the phrase ‘trans rights’?",
  ...
  },
  {
    ...
    questions: [
      ...
      "Can adopting a trans identity ever amplify dysphoria instead of relieving it?",
      ...
      "What role does social-media algorithmic content play in identity exploration?",
  ...
  },
  {
    ...
    questions: [
      ...
      "What role have psychedelic-assisted therapies played in some detrans stories?",
    ],
  },
  {
