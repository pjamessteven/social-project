...
export type CodeArtifact = Artifact<CodeArtifactData> & { type: "code" };
...
export function extractLastArtifact(
  ...
  if (type) {
    ...
    if (type === "code") return lastArtifact as CodeArtifact;
    if (type === "document") return lastArtifact as DocumentArtifact;
  }
