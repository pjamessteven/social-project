...
const metadata: Metadata = {
  ...
  description:
    "GenderAffirming.AI is powered by real trans experiences. Use it for transition help and advice, or as a virtual gender-affirming therapist for MTF and FTM transgender people.",
  openGraph: {
    title: "genderaffirming.ai | Talk to 600,000+ trans people",
    description:
      "GenderAffirming.AI is powered by real trans experiences. Use it for transition help and advice, or as a virtual gender-affirming therapist for MTF and FTM transgender people.",
