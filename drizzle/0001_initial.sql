...
CREATE TABLE IF NOT EXISTS "detrans_research_cache" (
...
CREATE INDEX IF NOT EXISTS "idx_detrans_research_cache_question" ON "detrans_research_cache" ("question_name");
CREATE INDEX IF NOT EXISTS "idx_detrans_research_cache_created" ON "detrans_research_cache" ("created_at");
...
DO $$ BEGIN
 ALTER TABLE "detrans_research_cache" ADD CONSTRAINT "detrans_research_cache_question_name_detrans_questions_name_fk" FOREIGN KEY ("question_name") REFERENCES "detrans_questions"("name") ON DELETE no action ON UPDATE no action;
EXCEPTION
